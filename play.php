...
@keyframes blur-text {
     ...
     .plyr__video-wrapper::before {
        ...
        height: 35px;
        width: 35px;
        background: url('<?php echo @$ASUR['Rimg']; ?>') no-repeat;
    ...
    .plyr__video-wrapper::after {
        ...
        height: 150px;
        width: 350px;
        background: url('<?php echo @$ASUR['Limg']; ?>') no-repeat;
...
<div class="loading-text">                                        
    <span style="color:#FF9966"><?php echo @$ASUR['span'][0]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][1]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][2]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][3]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][4]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][5]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][6]; ?></span>
    <span style="color:#FF9966"><?php echo @$ASUR['span'][7]; ?></span>
    <span style="color:#FF0000"><?php echo @$ASUR['span'][8]; ?></span>
    <span style="color:#FF0000"><?php echo @$ASUR['span'][9]; ?></span>
    <span style="color:#FF0000"><?php echo @$ASUR['span'][10]; ?></span>
    <span style="color:#FF0000"><?php echo @$ASUR['span'][11]; ?></span>
    <span style="color:#FF0000"><?php echo @$ASUR['span'][12]; ?></span>
    <span style="color:#66CC66"><?php echo @$ASUR['span'][13]; ?></span>
    <span style="color:#66CC66"><?php echo @$ASUR['span'][14]; ?></span>
    <span style="color:#66CC66"><?php echo @$ASUR['span'][15]; ?></span>
</div>
</div>

    <video autoplay controls crossorigin poster="<?php echo $ASUR['pimg']; ?>" playsinline>
